...
python3 -m torch.distributed.run --nproc_per_node 8 --nnodes 4 --node_rank 0 --master_addr $MASTER_ADDR --master_port $MASTER_PORT /root/test_network/train_model_pt.py \
